            ...
            <div class="col-md-4 col-xl-3">
                <div class="card bg-c-blue order-card">
                    <div class="card-block">
                        ...
                        <h2 class="text-right d-flex justify-content-around align-items-center"><i class="fa fa-cart-plus f-left"></i><span>{{ $reservationsCount }}</span></h2>
                    </div>
                </div>
            </div>
