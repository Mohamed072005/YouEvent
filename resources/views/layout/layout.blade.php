...
<body>
    <header class="p-2 bg-body-tertiary">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="w-50 d-flex justify-content-evenly align-items-center">
                ...
                <div class="">
                    <a href="{{ route('to.add.event') }}" class="navbar-brand">
                        <h5 class="mt-2">Create Event</h5>
                    </a>
                </div>
                <div class="">
                    <a href="{{ route('to.add.categorie') }}" class="navbar-brand">
                        <h5 class="mt-2">Create Categorie</h5>
                    </a>
                </div>
                <div class="">
                    <a href="{{ route('to.find.event') }}" class="navbar-brand">
                        <h5 class="mt-2">Find Event</h5>
                    </a>
                </div>
            </div>
            <div class="dropdown">
    ...
    <main class="row">
        <div class="col-1 offcanvas-content">
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" height="20" width="20" id="Arrow-Button-Right-1--Streamline-Ultimate">
                    <desc>Arrow Button Right 1 Streamline Icon: https://streamlinehq.com</desc>
                    <g id="Arrow-Button-Right-1--Streamline-Ultimate">
                        <path d="M15.843333333333334 14a3.0800000000000005 3.0800000000000005 0 0 1 -0.8983333333333334 2.1933333333333334l-11.129999999999999 11.129999999999999a2.065 2.065 0 0 1 -2.916666666666667 -2.916666666666667l10.196666666666667 -10.196666666666667a0.31500000000000006 0.31500000000000006 0 0 0 0 -0.42L0.8983333333333334 3.5933333333333337a2.065 2.065 0 0 1 2.916666666666667 -2.916666666666667l11.129999999999999 11.129999999999999a3.0800000000000005 3.0800000000000005 0 0 1 0.8983333333333334 2.1933333333333334Z" fill="#000000" stroke-width="1"></path>
                        <path d="M27.708333333333336 14a3.091666666666667 3.091666666666667 0 0 1 -0.875 2.1933333333333334l-11.129999999999999 11.129999999999999a2.065 2.065 0 0 1 -2.916666666666667 -2.916666666666667l10.196666666666667 -10.196666666666667a0.2916666666666667 0.2916666666666667 0 0 0 0 -0.42l-10.231666666666667 -10.196666666666667a2.065 2.065 0 0 1 2.916666666666667 -2.916666666666667L26.833333333333336 11.806666666666667a3.091666666666667 3.091666666666667 0 0 1 0.875 2.1933333333333334Z" fill="#000000" stroke-width="1"></path>
                    </g>
                </svg></button>
        </div>
            ...
            <div class="offcanvas-body">
                <div class="">
                    <aside class="aside p-2">
                        ...
                        <div class="">
                            <a class="navbar-brand" href="{{ route('get.categorie') }}">
